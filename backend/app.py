...
For each item, provide the LaTeX code within a display math environment ($$...$$ or \begin{{equation}}
   % Your mathematical expression goes here
\end{{equation}}). Where appropriate, include comments within the LaTeX code to explain specific commands or choices.
